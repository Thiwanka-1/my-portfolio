  ...
  return (
    <nav className="bg-transparent">
      <div className="flex items-center justify-between py-5">
        ...
        <li>
            <Link className="block px-4 py-2 no-underline outline-none hover:no-underline" href="/"><div className="text-sm text-white transition-colors duration-300 hover:text-pink-600">HOME</div></Link>
          </li>
          <li>
